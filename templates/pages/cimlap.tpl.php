...
included, verify that the path is correct and try again.
At line:3 char:9
+         <h2>Üdvözöljük a Mini honlapnál</h2>
+         ~
    + CategoryInfo          : ObjectNotFound: (<:String) [], CommandNotFoundEx 
   ception
    + FullyQualifiedErrorId : CommandNotFoundException
...
included, verify that the path is correct and try again.
At line:4 char:9
+         <p>Modern kisvállalati weboldal készítése PHP, HTML, CSS és J ...
+         ~
    + CategoryInfo          : ObjectNotFound: (<:String) [], CommandNotFoundEx 
   ception
    + FullyQualifiedErrorId : CommandNotFoundException
...
included, verify that the path is correct and try again.
At line:9 char:13
+             <p>Ezen az oldalon gyakorlatilag megvalósítottuk a regisz ...
+             ~
    + CategoryInfo          : ObjectNotFound: (<:String) [], CommandNotFoundEx 
   ception
    + FullyQualifiedErrorId : CommandNotFoundException
...
included, verify that the path is correct and try again.
At line:13 char:17
+                 <figcaption>Lokális bemutató videó</figcaption>
+                 ~
    + CategoryInfo          : ObjectNotFound: (<:String) [], CommandNotFoundEx 
   ception
    + FullyQualifiedErrorId : CommandNotFoundException
...
included, verify that the path is correct and try again.
At line:16 char:21
+                     A böngészo nem támogatja a beágyazott videót.
+                     ~
...
included, verify that the path is correct and try again.
At line:21 char:17
+                 <iframe width="320" height="180" src="https://www.you ...
+                 ~
    + CategoryInfo          : ObjectNotFound: (<:String) [], CommandNotFoundEx 
   ception
    + FullyQualifiedErrorId : CommandNotFoundException
...
included, verify that the path is correct and try again.
At line:27 char:9
+         <p>Az alkalmazás bemutató helyszíne például a Pallasz Athéné  ...
+         ~
    + CategoryInfo          : ObjectNotFound: (<:String) [], CommandNotFoundEx 
   ception
    + FullyQualifiedErrorId : CommandNotFoundException
